		...
		<div className="login-body">
			...
			<div className="admin-container">
				<div className="admin-container-left">
					<img className="admin-image" src={loginImage} alt="admin image" />
				</div>
				<div className="admin-container-right">
					<form>
						...
						<label>Login</label>
						<input type="text" placeholder="Login" id="login" autoComplete="on" />
						<label>Heslo</label>
						<input type="password" placeholder="Heslo" id="password" autoComplete="on" />
